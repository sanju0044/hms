            ...
            <div class="content">
                ...
                <div class="d-flex align-items-sm-center flex-sm-row flex-column gap-2 pb-3 mb-3 border-1 border-bottom">
                    <div class="flex-grow-1">
                        <h4 class="fw-semibold mb-0"> IP BILLING LIST </h4>
                    </div>
                    <div class="text-end d-flex">
                        ...
                        <a href="#" class="btn btn-primary ms-2 fs-13 btn-md" data-bs-toggle="modal" data-bs-target="#add_modal"><i class="ti ti-plus me-1"></i>ADD IP BILLING </a>
                    </div>
				</div>
				<!-- End Page Header -->
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title text-dark fw-bold">IP BILLING</h5>
                ...
                <div class="modal-body pb-0">
                    ...
                    <div class="form">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label class="form-label mb-1 fw-medium">Ward<span class="text-danger ms-1">*</span></label>
                                     <select class="select form-control">
                                        <option value="m-1">Select</option>
                                        <option value="m-2">General</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label class="form-label mb-1 fw-medium">Floor<span class="text-danger ms-1">*</span></label>
                                     <select class="select form-control">
                                        <option value="m-1">Select</option>
                                        <option value="m-2">First Floor</option>
                                        <option value="m-2">Secound Floor</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label class="form-label mb-1 fw-medium">Bill Amount<span class="text-danger ms-1">*</span></label>
                                     <input type="number" class="form-control" placeholder="Enter Bill Amount">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label class="form-label mb-1 fw-medium">Advance Paid<span class="text-danger ms-1"></span></label>
                                     <input type="number" class="form-control" placeholder="Advance Paid">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label class="form-label mb-1 fw-medium">Refund<span class="text-danger ms-1"></span></label>
                                     <input type="number" class="form-control" placeholder="Refund">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label class="form-label mb-1 fw-medium">Tolal Amount<span class="text-danger ms-1">*</span></label>
                                     <input type="number" class="form-control" placeholder="Tolal Amount">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
                            ...
                            <div class="col-md-12">
                                <div class="mb-3">
                                    ...
                                    <select class="select form-control">
                                        <option value="m-1">Select</option>
                                        <option value="m-2">Admitted</option>
                                        <option value="m-3">Discharged</option>
                                    </select>
                                </div>
                            </div>
                        </div>
