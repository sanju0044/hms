...
<head>
    ...
    <title>Designation - Bootstrap 5 Admin Template</title>
    ...
    <!-- Theme Config Js -->
    <script src="assets/js/theme-script.js" type="dd83f5e012e20569acd7d320-text/javascript"></script>
...
<body>
        ...
        <header class="navbar-header">
            <div class="page-container topbar-menu">
                <div class="d-flex align-items-center gap-2">
                    ...
                    <a id="mobile_btn" class="mobile-btn" href="designation.html#sidebar">
                                ...
                                <li class="submenu">
                                    ...
                                    <ul>
                                        ...
                                        <li class="submenu submenu-two">
                                            <a href="designation.html#">Calls<span class="menu-arrow inside-submenu"></span></a>
                                            <ul>
                                        ...
                                        <li class="submenu submenu-two">
                                            <a href="designation.html#">Invoices<span class="menu-arrow inside-submenu"></span></a>
                                            <ul>
    ...
    <!-- jQuery -->
    <script src="assets/js/jquery-3.7.1.min.js" type="dd83f5e012e20569acd7d320-text/javascript"></script>

    <!-- Bootstrap Core JS -->
    <script src="assets/js/bootstrap.bundle.min.js" type="dd83f5e012e20569acd7d320-text/javascript"></script>

	<!-- Simplebar JS -->
	<script src="assets/plugins/simplebar/simplebar.min.js" type="dd83f5e012e20569acd7d320-text/javascript"></script>

    <!-- Datetimepicker JS -->
    <script src="assets/js/moment.min.js" type="dd83f5e012e20569acd7d320-text/javascript"></script>
    <script src="assets/js/bootstrap-datetimepicker.min.js" type="dd83f5e012e20569acd7d320-text/javascript"></script>

    <!-- Bootstrap Tagsinput JS -->
    <script src="assets/plugins/bootstrap-tagsinput/bootstrap-tagsinput.js" type="dd83f5e012e20569acd7d320-text/javascript"></script>

    <!-- Datatable JS -->
    <script src="assets/js/jquery.dataTables.min.js" type="dd83f5e012e20569acd7d320-text/javascript"></script>
    <script src="assets/js/dataTables.bootstrap5.min.js" type="dd83f5e012e20569acd7d320-text/javascript"></script>

    <!-- Select2 JS -->
    <script src="assets/plugins/select2/js/select2.min.js" type="dd83f5e012e20569acd7d320-text/javascript"></script>

    <!-- Main JS -->
    <script src="assets/js/doctors.js" type="dd83f5e012e20569acd7d320-text/javascript"></script>
    <script src="assets/js/script.js" type="dd83f5e012e20569acd7d320-text/javascript"></script>

<script src="../../cdn-cgi/scripts/7d0fa10a/cloudflare-static/rocket-loader.min.js" data-cf-settings="dd83f5e012e20569acd7d320-|49" defer></script></body>
