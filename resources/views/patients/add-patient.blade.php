                    ...
                    <div class="col-lg-10 mx-auto">
                        ...
                        <div class="d-flex align-items-sm-center flex-sm-row flex-column gap-2 mb-3">
                            <div class="flex-grow-1">
                                <h6 class="fw-bold mb-0 d-flex align-items-center"><a href="doctors.html"><i class="ti ti-chevron-left me-1 fs-14"></i>Patient</a></h6>
                            </div>
                        </div>
                        <!-- End Page Header -->
                         ...
                         <div class="card mb-0">
                            ...
                            <div class="card-body">
                                ...
                                <form action="doctors.html">
                                    <div class="pb-0">
                                        ...
                                        <div class="row">
                                            <div class="px-3 py-2 mb-3 feild-head">
                                                <h6 class="fw-bold mb-0 shadow p-3 mt-3 mb-3 bg-body rounded">Patient Details</h6>
                                            </div>
                                            <div class="col-lg-12">
                                    ...
                                    <div class="px-3 py-2 mb-3 feild-head">
                                        <h6 class="fw-bold mb-0 shadow p-3 mt-3 mb-3 bg-body rounded">Address Relation </h6>
                                    </div>
                                    <div class="pb-0">
                                        <div class="row">
                                            <div class="col-lg-4">
                                                <div class="mb-3">
                                                    <label class="form-label">Patient Relation<span class="text-danger ms-1"></span></label>
                                                        <input type="text" class="form-control" placeholder="Enter Patient Relation">
                                                </div>
                                            </div>
                                            <div class="col-lg-4">
                                                <div class="mb-3">
                                                    <label class="form-label">Patient Relation Name<span class="text-danger ms-1"></span></label>
                                                    <input type="text" class="form-control" placeholder="Enter Patient Relation">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-4">
                                                <div class="mb-3">
                                                    <label class="form-label">Patient Relation Mobile <span class="text-danger"></span></label>
                                                    <input type="text" class="form-control" placeholder="Enter Patient Relation Mobile ">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                     <div class="px-3 py-2 mb-3 feild-head">
                                        <h6 class="fw-bold mb-0 shadow p-3 mt-3 mb-3 bg-body rounded">Emergency Contact</h6>
                                    </div>
                                    <div class="pb-0">
                                        <div class="row">
                                            <div class="col-lg-4">
